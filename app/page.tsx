      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-left">
            ...
            <h1>Week 6: Charlotte Catholic <span className="hl">takes the throne</span></h1>
            <p className="hero-desc">
              After some shakeup at the top, Charlotte Catholic and Lake Norman jump to our top 2 spots. Hoggard, Ardrey Kell, and Athens Drive enter the top 10. See the full Week 6 breakdown.
            </p>
...
<Link href="/rankings" className="hero-featured" style={{ textDecoration: "none", color: "inherit" }}>
            <div className="hero-featured-img" style={{ background: "#E8E6E1", padding: "0" }}>
              <svg width="100%" viewBox="0 0 800 500" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="400" y="155" textAnchor="middle" fontFamily="Georgia, serif" fontSize="48" fill="#7BAFD4" fontWeight="700" letterSpacing="2">WEEK 6</text>
            ...
            <div className="hero-featured-body">
              ...
              <h3>THLN Week 6 Power Rankings are live</h3>
        ...
        <main>
          ...
          <article className="article-card" onClick={() => window.location.href='/blog/heroes-bowl-preview'} style={{cursor:'pointer'}}>
            ...
            <div className="article-info">
              ...
              <span className="meta">April 6, 2026 · 15 min read</span>
            </div>
          </article>
          <article className="article-card" onClick={() => window.location.href='/blog/games-of-the-week'} style={{cursor:'pointer'}}>
            <div className="article-thumb" style={{ background: "#0B1D3A", border: "none", overflow: "hidden" }}>
              <svg width="100%" height="100%" viewBox="0 0 800 500" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="400" y="310" textAnchor="middle" fontFamily="Georgia, serif" fontSize="24" fill="#7BAFD4" fontWeight="700" letterSpacing="3">WEEK 6</text>
              </svg>
            </div>
            <div className="article-info">
