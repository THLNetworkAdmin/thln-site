      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-left">
            ...
            <h1>Week 5: Hough holds firm, Ardrey Kell <span className="hl">joins the top 10</span></h1>
            <p className="hero-desc">
              The Huskies stay on top after dominant wins over CSD and Weddington. Middle Creek and Charlotte Catholic rise in the 1-6A ranks. Ardrey Kell enters the rankings after taking down Marvin Ridge. See the full Week 5 breakdown.
            </p>
...
<Link href="/rankings" className="hero-featured" style={{ textDecoration: "none", color: "inherit" }}>
            <div className="hero-featured-img" style={{ background: "#E8E6E1", padding: "0" }}>
              <svg width="100%" viewBox="0 0 800 500" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="400" y="155" textAnchor="middle" fontFamily="Georgia, serif" fontSize="48" fill="#7BAFD4" fontWeight="700" letterSpacing="2">WEEK 5</text>
            ...
            <div className="hero-featured-body">
              ...
              <h3>THLN Week 5 Power Rankings are live</h3>
          ...
          <article className="article-card" onClick={() => window.location.href='/blog/games-of-the-week'} style={{cursor:'pointer'}}>
            <div className="article-thumb" style={{ background: "#0B1D3A", border: "none", overflow: "hidden" }}>
              <svg width="100%" height="100%" viewBox="0 0 800 500" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="400" y="310" textAnchor="middle" fontFamily="Georgia, serif" fontSize="24" fill="#7BAFD4" fontWeight="700" letterSpacing="3">WEEK 5</text>
              </svg>
            </div>
